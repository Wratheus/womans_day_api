        ...
        if (taskRepository.count() == 0) {
            List<Task> tasks = List.of(
                    ...
                    Task.builder()
                            ...
                            .description("Произнесите скороговорку «Сиреневенький подплинтусозаврик с подвыподвертом» без ошибок. Формат: видео.")
                            .reward(50)
                            .type(TaskType.MEDIA)
                            .build(),
                    Task.builder()
                    ...
                    Task.builder()
                            ...
                            .description("Найдите самого серьёзного айтишника и рассмешите. Формат: видео.")
                            .reward(35)
                            .type(TaskType.MEDIA)
                            .collaborative(true)
                            .build(),
                    Task.builder()
                            .title("Косички айтишнику с самыми длинными волосами")
                            .description("Найдите парня из IT с самыми длинными волосами, заплетите косички и сделайте селфи. Грустные фото не принимаются.")
                            .reward(35)
                            .type(TaskType.MEDIA)
                            .collaborative(true)
                            .build(),
                    Task.builder()
                            ...
                            .description("Убедите айтишника объяснить «что он делает» максимально романтично. Формат: видео.")
                            .reward(35)
                            .type(TaskType.MEDIA)
                            .collaborative(true)
                            .build(),
                    ...
                    // ======= Легкое (20) =======
                    Task.builder()
                            .title("Праздничный апгрейд от айтишника")
                            .description("Попросите айтишника сделать «праздничный апгрейд» (смешная заставка). Формат: фото.")
                            .reward(20)
                            .type(TaskType.MEDIA)
                            .collaborative(true)
                            .build(),
                    Task.builder()
                            ...
                            .description("Slow-mo видео, как IT драматично нажимает Enter.")
                            .reward(20)
                            .type(TaskType.MEDIA)
                            .collaborative(true)
                            .build(),
